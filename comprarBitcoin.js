...
const ComprarBitcoin = {
  getMarkets: function() {
    const options = {
      uri: Endpoints.api.comprarBitcoin,
  ...
  getBalance: function(asset) {
    const options = {
      ...
      params: {
        apikey: process.env.COMPRAR_BITCOIN_APIKEY,
        apisecret: process.env.COMPRAR_BITCOIN_APISECRET,
        nonce: Nonce(),
        asset
      }
    };
